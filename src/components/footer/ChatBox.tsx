			...
			<div className="flex flex-col max-w-[300px] overflow-hidden pointer-events-auto">
				<div>
					...
					<div className="sticky flex overflow-hidden bottom-0 w-full h-[48px]">
						<img className="w-12 h-12 border-[2px] border-[var(--dark-gray)]" src="/images/characters/heist16017.png" />
						<input className="w-full h-full border-2 font-semibold px-3 py-2 text-[var(--black)]" type="text" placeholder="Write message here ..." required />
